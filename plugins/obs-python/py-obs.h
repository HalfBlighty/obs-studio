...
static PyObject* py_obs_blog(PyObject* self, PyObject* args)
{
...
static PyObject* py_obs_register_source(PyObject* self, PyObject* args)
{
	UNUSED_PARAMETER(self);
	long argLength = PyTuple_Size(args);
	if (argLength != 1) {
...
static PyObject* py_obs_current_module(PyObject* self, PyObject* args)
{
	UNUSED_PARAMETER(self);
	...
	SWIG_result = libobs_to_py_swig(SWIG_str_obs_module_t,
	                                obs_current_module(),
	                                0,
	                                &py_swig_obs_module_pointer);
...
static PyMethodDef py_obs_methods[] = {
        ...
        {"obs_register_source",
         ...
         METH_VARARGS,
         "Registers a new source with obs."},
        {"obs_current_module",
         py_obs_current_module,
         METH_NOARGS,
         "Helper function to get the current module pointer"},
        {NULL, NULL, 0, NULL}};
